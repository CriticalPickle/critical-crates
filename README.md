Critical Crates
=======
**THIS IS A WORK IN PROGRESS AND DOES NOT HAVE A STABLE RELEASE IN 1.21.11! FOR STABLE RELEASE OF CRITICAL CRATES REFER TO "master" BRANCH.**
...
This mod is currently only developed and maintained for Minecraft [NeoForge](https://neoforged.net/) in version [1.21.1](https://github.com/CriticalPickle/critical-crates/tree/master) and 1.21.11 (this github branch), but may be updated to newer and different versions/loaders in the future.
