...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> IRON_OAK_CRATE = registerCrateBlockWithItem("iron_oak_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_SPRUCE_CRATE = registerCrateBlockWithItem("iron_spruce_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_BIRCH_CRATE = registerCrateBlockWithItem("iron_birch_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_JUNGLE_CRATE = registerCrateBlockWithItem("iron_jungle_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_ACACIA_CRATE = registerCrateBlockWithItem("iron_acacia_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_DARK_OAK_CRATE = registerCrateBlockWithItem("iron_dark_oak_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_MANGROVE_CRATE = registerCrateBlockWithItem("iron_mangrove_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_CHERRY_CRATE = registerCrateBlockWithItem("iron_cherry_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_BAMBOO_CRATE = registerCrateBlockWithItem("iron_bamboo_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_CRIMSON_CRATE = registerCrateBlockWithItem("iron_crimson_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.5F).sound(SoundType.WOOD), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_WARPED_CRATE = registerCrateBlockWithItem("iron_warped_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.5F).sound(SoundType.WOOD), "iron", "wood"));
    ...
    public static final DeferredBlock<Block> IRON_GLASS_CRATE = registerCrateBlockWithItem("iron_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_WHITE_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_white_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_LIGHT_GRAY_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_light_gray_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_GRAY_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_gray_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_BLACK_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_black_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_BROWN_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_brown_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_RED_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_red_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_ORANGE_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_orange_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_YELLOW_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_yellow_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_LIME_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_lime_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_GREEN_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_green_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_CYAN_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_cyan_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_LIGHT_BLUE_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_light_blue_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_BLUE_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_blue_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_PURPLE_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_purple_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_MAGENTA_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_magenta_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_STAINED_GLASS), "iron", "glass"));
    ...
    public static final DeferredBlock<Block> IRON_PINK_STAINED_GLASS_CRATE = registerCrateBlockWithItem("iron_pink_stained_glass_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_STAINED_GLASS), "iron", "glass"));

    public static final DeferredBlock<Block> IRON_CRATE = registerCrateBlockWithItem("iron_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK), "iron", "ore"));

    public static final DeferredBlock<Block> DIRT_CRATE = registerCrateBlockWithItem("dirt_crate", () -> new SoilCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DIRT)));
    public static final DeferredBlock<Block> IRON_DIRT_CRATE = registerCrateBlockWithItem("iron_dirt_crate", () -> new OreCrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DIRT), "iron", "soil"));
