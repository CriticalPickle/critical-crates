...
public class OreUpgradeGlassCrateBlockEntityRenderer implements BlockEntityRenderer<OreCrateBlockEntity> {
    public OreUpgradeGlassCrateBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(OreCrateBlockEntity blockEntity, float v, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int i1) {
